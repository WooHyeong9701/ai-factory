...
우선순위 높은 순서대로 정렬하고, 각 작업의 의존관계를 명시하세요.`,
  ...
  // Provider Settings
  provider: '프로바이더',
  ps_title: 'AI 프로바이더 설정',
  ps_sub: 'GPT, Claude, Gemini 등 원하는 모델을 본인 API 키로 연결하세요.',
  ps_securityWarn: 'API 키는 이 브라우저에만 저장되며 서버로 전송되지 않습니다. 공용 PC에서는 사용 후 삭제하세요.',
  ps_apiKey: 'API 키',
  ps_baseUrl: 'Base URL',
  ps_baseUrlHint: '기본값을 덮어쓸 때만 입력',
  ps_getKey: '키 발급',
  ps_show: '보기',
  ps_hide: '숨기기',
  ps_clear: '이 프로바이더 정보 삭제',
  ps_done: '완료',
  ps_connected: '연결됨',
  ps_local: '로컬',
  ps_custom: '커스텀',
  ps_notConfigured: '키 필요',
  ps_configureBtn: '프로바이더 설정 열기',
  ps_customModel: '직접 입력...',
  ps_ollamaHint: 'Ollama는 상단 연결 설정에서 관리합니다.',
}
